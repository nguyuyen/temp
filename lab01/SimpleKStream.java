...
public class SimpleKStream {
    ...
    public static void main(String args[]) {
        ...
        airStream.foreach((key, value) -> {
            System.out.println("Air Stream - Key: " + key + ", Value: " + value.toStr());
        });
    ...
    //             }
    //             double air_avg_new = (air_count * air_avg.get(i) + new_data) / (air_count + 1);
    //             air_std.set(i, Math.sqrt((air_count * air_std.get(i) * air_std.get(i)
    //                     + (new_data - air_avg_new) * (new_data - air_avg.get(i))) / (air_count + 1)));
    ...
    //                 new_data = Double.parseDouble(list.get(i));
    //             }
    //             double earth_avg_new = (earth_count * earth_avg.get(i) + new_data) / (earth_count + 1);
    //             earth_std.set(i, Math.sqrt((earth_count * earth_std.get(i) * earth_std.get(i)
    //                     + (new_data - earth_avg_new) * (new_data - earth_avg.get(i))) / (earth_count + 1)));
    ...
    //                 new_data = Double.parseDouble(list.get(i));
    //             }
    //             double water_avg_new = (water_count * water_avg.get(i) + new_data) / (water_count + 1);
    //             water_std.set(i, Math.sqrt((water_count * water_std.get(i) * water_std.get(i)
    //                     + (new_data - water_avg_new) * (new_data - water_avg.get(i))) / (water_count + 1)));
    ...
    //                     // Each record waits record from other stream at most 1s
    //                     StreamJoined.with(Serdes.String(), new EnvSerde(), Serdes.Integer()));
    //     // StreamJoined.with(<Key datatype>, <stream 1 Value datatype>, <stream 2 Value
    //     // datatype>)
